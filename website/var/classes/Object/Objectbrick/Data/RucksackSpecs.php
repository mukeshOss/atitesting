...
/**
* Set volume - <img style="height:40px; float:left; margin:-10px 10px 0 0" src="/website/static/backend/img/bricks/rucksacks-specs/volume.png"/> Volume
* @return string
*/
...
/**
* Set weight - <img style="height:40px; float:left; margin:-10px 10px 0 0" src="/website/static/backend/img/bricks/rucksacks-specs/weight.png"/> Weight
* @return string
*/
...
/**
* Set load - <img style="height:40px; float:left; margin:-10px 10px 0 0" src="/website/static/backend/img/bricks/rucksacks-specs/load.png"/> Load
* @return string
*/
...
/**
* Set material - <img style="height:40px; float:left; margin:-10px 10px 0 0" src="/website/static/backend/img/bricks/rucksacks-specs/material.png"/> Material
* @return string
*/
...
/**
* Set expandTo - <img style="height:40px; float:left; margin:-10px 10px 0 0" src="/website/static/backend/img/bricks/rucksacks-specs/expand.png"/> Expand
* @return string
*/
