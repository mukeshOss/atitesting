<div id="header">
                <div id="headerLogo">
                    ...
                    <div id="headerLogo-middle">
                        <a id="ctl00_headerLogoLink" class="headerLogo-link" href="/"><img id="ctl00_headerLogoLinkSpacer" class="headerLogo-link-spacer" src="/website/static/atitesting/css/App_Themes/AtiTesting/Images/blank.gif" style="border-width:0px;"></a>
                    </div>
...
<fieldset class="sf_searchBox">
    ...
    <div class="clear">
                    ...
                    <div id="headerCallout-middle">
                        ...
                        <br> <style>
    @font-face {
    font-family: archerbookitalic; src:url("/website/static/atitesting/Libraries/fonts/Archer_BookItalic.sflb.png");
    }
    @font-face {
    font-family: archermediumitalic; src:url("/website/static/atitesting/Libraries/fonts/Archer_MediumItalic.sflb.png");
    }
    @font-face {
    font-family: Avenir.book; src:url("/website/static/atitesting/Libraries/fonts/Avenir.sflb.png");
    }
    img {
    border:none;
    }
    ...
    height:50px;
    float:left;
    background:url('/website/static/atitesting/Libraries/new-ati/blueribbon-left.sflb.png')
    }
    .bribbonmiddle {
    ...
    height:50px;
    float:left;
    background:url('/website/static/atitesting/Libraries/new-ati/blueribbon-right.sflb.png')
    }
    .left30i {
    float: left;
    margin-right: 20px;
    ...
    .videocontainer1 {
    background: url("/website/static/atitesting/Libraries/new-ati/iphonebg.sflb.png") no-repeat scroll 0 0 transparent;
    height: 328px;
    padding-top: 56px;
    width: 223px;
    }
    ...
    .righthalf12 {
    background: url("/website/static/atitesting/Libraries/new-ati/monitorbg.sflb.png") no-repeat scroll 0 0 transparent;
    float: left;
    height: 280px;
    padding-left: 15px;
    padding-top: 7px;
    ...
    border:1px solid #E9E9E9;
    padding:20px;
    background: url('/website/static/atitesting/Libraries/new-ati/background1.sflb.png');
    margin-bottom:20px;
    }
    .bannercontain h1 {
    background:none;
    ...
    height:6px;
    float:left;
    background:url('/website/static/atitesting/Libraries/new-ati/blue-ribbont.sflb.png');
    ...
    height:6px;
    float:left;
    background:url('/website/static/atitesting/Libraries/new-ati/red-ribbont.sflb.png');
    background-repeat:no-repeat;
    width:679px;
    }
    .redribbonbottom {
    ...
    float:left;
    height:50px;
    background:url('/website/static/atitesting/Libraries/new-ati/redribbon-right.sflb.png');
    }
    .ribboncontain {
    width:679px;
    float:left;
    ...
    margin-bottom:5px;
    margin-left:5px;
    background: url("/website/static/atitesting/Libraries/new-ati/redbutton.sflb.png") no-repeat scroll right center transparent;
