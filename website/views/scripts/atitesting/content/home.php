...
<?php endif; ?>
  ...
  <?php } ?>         
        ...
        <a title="ATI Facebook" target="_blank" class="facebook" id="ctl00_footerContent_facebook" href="#"><img border="0" style="border-width:0px;" alt="ATI Facebook" src="/website/static/atitesting/css/App_Themes/AtiTesting/Images/facebook.png"></a>
